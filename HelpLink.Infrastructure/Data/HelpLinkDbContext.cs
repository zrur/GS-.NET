...
public class HelpLinkDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ✅ FORÇAR TIPO PARA PROPRIEDADES INT NÃO BOOL
        foreach (var entityType in modelBuilder.Model.GetEntityTypes())
        {
            foreach (var property in entityType.GetProperties())
            {
                if (property.ClrType == typeof(int))
                {
                    ...
                    if (name.Equals("Ativo", StringComparison.OrdinalIgnoreCase) ||
                        name.Equals("Verificada", StringComparison.OrdinalIgnoreCase))
                    {
                        // Garantir que seja tratado como int, não bool
    ...
    modelBuilder.Entity<Usuario>(entity =>
    {
        ...
        // ✅ CONVERSÃO DENTRO DA CONFIGURAÇÃO
    ...
    modelBuilder.Entity<Instituicao>(entity =>
    {
        ...
        // ✅ CONVERSÕES DENTRO DA CONFIGURAÇÃO
        entity.Property(e => e.Ativo)
            .HasColumnType("NUMBER(1)")
            .HasConversion(v => v, v => v);
